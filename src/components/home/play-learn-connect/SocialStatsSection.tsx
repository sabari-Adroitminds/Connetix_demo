    ...
    return (
        <section className="py-8   bg-white flex flex-col lg:flex-row justify-between items-center gap-6">
            ...
            <div className="text-center lg:text-left">
                ...
                <p className="text-[14px] lg:text-[18px] text-font/80 mt-2 font-[300]">
...
const SocialStat = ({ icon, count }: SocialStatProps) => {
    return (
        <div className="flex items-center gap-2 px-4 py-2 w-[230px] border border-primary-light h-[78px] rounded-xl  bg-white">
