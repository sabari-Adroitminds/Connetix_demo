...
const MobileMenu = () => {
  ...
  return (
    ...
    <div  onClick={handleToggle}>
          ...
          <p className=' font-bold text-[14px] text-primary '>{open ? 'Close' : 'Menu'}</p>
        
    </div>

          {open  && <div className={clsx( ' absolute z-1000 -left-4  top-[55px] min-w-[100vw] min-h-full bg-white p-4')}>
              <Accordion>
