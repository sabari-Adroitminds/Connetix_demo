        ...
        <div className="w-full max-w-[752px]">
          ...
          <div className="w-full max-w-[649px]">
            ...
            <span className="text-[16px] leading-[26px] tracking-[-0.5px] text-navy font-medium">
              We&apos;d love to hear from you. Please use the form below for all
              your Connetix inquiries, questions and feedback.
            </span>
          </div>

          {/* form */}
          <div className="h-fit mt-8 w-full max-w-[664px]">
            <Form {...methods}>
              <form
                className="flex flex-col gap-5"
                onSubmit={methods.handleSubmit(onSubmit)}
              >
                <div className="w-full flex flex-row flex-wrap items-center max-lg:justify-center gap-6 grow">
                  <Input
                    name="firstName"
                    type="text"
